...
declare global {
  interface Window {
    ...
    triggerPWAInstall: () => Promise<{ outcome: 'accepted' | 'dismissed' | 'not_available'; platform?: string }>;
    showPWAPrompt: () => void;
