...
// Multer: memory storage, 20MB limit (matches frontend limit), image-only filter
const upload = multer({
...
/**
 * POST /api/sogni/transcode
 * Accepts multipart file upload, transcodes WebP/HEIF/HEIC/AVIF to JPEG.
